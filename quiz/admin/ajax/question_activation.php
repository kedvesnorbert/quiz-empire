...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) 
{
    ...
    else
    {
        ...
        mysqli_query($con, "CALL question_activation('" . mysqli_real_escape_string($con, $_POST['p_questionid']) . "', '" . mysqli_real_escape_string($con, $_SESSION['user_id']) . "', '" . mysqli_real_escape_string($con, $_POST["p_action"]) . "', @p_response)");
