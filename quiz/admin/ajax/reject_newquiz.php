...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) 
{
    ...
    elseif(!isset($_POST['p_rejectquiz_reason']) || strlen($_POST["p_rejectquiz_reason"]) < 5 || strlen($_POST["p_rejectquiz_reason"]) > 100)
    {
        echo json_encode(array("resp"=>"Helytelen érték: p_rejectquiz_reason!"));
    }
    else
    {
        $con = connect();
        ...
        mysqli_query($con, "CALL reject_newquiz('" . mysqli_real_escape_string($con, $_POST['p_quizid']) . "', '" . mysqli_real_escape_string($con, $_SESSION['adminuser']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rejectquiz_reason']) . "', @response)");
