...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) 
{
    ...
    elseif(!isset($_POST['p_competitionid']) || !preg_match("/^[0-9]+$/", $_POST["p_competitionid"]) || $_POST["p_competitionid"] < 1 )
    {
        echo json_encode(array("resp"=>"Helytelen érték: p_competitionid!"));
    }
    ...
    else
    {
        ...
        mysqli_query($con, "CALL update_competition('" . mysqli_real_escape_string($con, $_POST['p_competitionid']) . "', '" . mysqli_real_escape_string($con, $_POST['p_themaid']) . "', '" . mysqli_real_escape_string($con, $_POST['p_color']) . "', '" . mysqli_real_escape_string($con, $_POST['p_announcement']) . "', '" . mysqli_real_escape_string($con, $_POST['p_startdate']) . "', '" . mysqli_real_escape_string($con, $_POST['p_enddate']) . "',  '" . mysqli_real_escape_string($con, $_POST['p_activity']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew1']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew2']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew3']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew4']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew5']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew6']) . "', '" . mysqli_real_escape_string($con, $_POST['p_rew7']) . "', '" . mysqli_real_escape_string($con, $_SESSION['user_id']) . "', @p_response)");
