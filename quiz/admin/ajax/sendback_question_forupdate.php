...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) 
{
    ...
    else
    {
        ...
        mysqli_query($con, "CALL sendback_question_forupdate('" . mysqli_real_escape_string($con, $_POST['p_questionid']) . "', '" . mysqli_real_escape_string($con, $_POST['p_moderatorcomment']) . "', '" . mysqli_real_escape_string($con, $_SESSION['user_id']) . "', @p_response)");
