...
require_once("../admin/db/db_connect.php");
...
else
{
	...
	$res = mysqli_query($con, "SELECT export_pdf_admin('" . mysqli_real_escape_string($con, $_GET['test_id']) . "', '" . $_SESSION['user_id'] . "', '" . mysqli_real_escape_string($con, $_SESSION['adminuser']) . "') AS visszaErtek");
	$row = mysqli_fetch_assoc($res);
	mysqli_close($con);
