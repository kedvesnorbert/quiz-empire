...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) 
{
	...
	else
	{
		...
		echo "<center><table id='questions_table' class='table table-bordered'><tr id='header_qtable'><td>Nr. <td>Kérdés szövege<td>Helyes válasz<td>Státusz\n";
		while($row = mysqli_fetch_assoc($res))
		{
			...
			echo "<td class='align-middle'>" . $k++ . ". <td class='align-middle'>" . htmlspecialchars($row['question']) . "<td class='align-middle'>" . htmlspecialchars($row['ans1']) . "<td style='text-align:center;' class='align-middle'>" . $statusz . "\n";
